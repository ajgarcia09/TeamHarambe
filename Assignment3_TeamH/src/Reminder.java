...
public class Reminder{
	 ...
	 * */
	public static boolean setReminder(String r, String Time, boolean test){
		String reminder = "";
		String reminderTime = "";
		if(test){ // if called by testing class execute if
			reminder = r;
			reminderTime = Time;
		}
		else{
			Scanner input = new Scanner(System.in);
			System.out.println(" Please enter your reminder");
			reminder = input.nextLine();
			System.out.println(" Please enter your date and time in format: dd/mm/yy hh:mm am/pm");
			reminderTime = input.nextLine().toLowerCase().replaceAll("\\s+","");
		}
		reminders.put(reminderTime, reminder);
		return true; // returns if execution went through;
	}
